...
INSERT INTO Dipendenti VALUES (1, 'alessio.hoxhallari@gmail.com', '12345678');

CREATE TABLE Sale(
    idSala INT NOT NULL PRIMARY KEY,
    nome VARCHAR(25) NOT NULL CHECK(nome IN('Sala Piccola', 'Sala Grande', 'Sala Platinum', 'Sala Riunione 1', 'Sala Riunione 2'))
);

INSERT INTO Sale VALUES (1,'Sala Piccola'), (2,'Sala Grande'), (3,'Sala Platinum'), (4,'Sala Riunione 1'), (5,'Sala Riunione 2');
...
CREATE TABLE Automobili(
    ...
    stato varchar(25) NOT NULL CHECK(stato IN('Usata', 'Nuova')),
    cambio varchar(25) NOT NULL CHECK(cambio IN('Manuale', 'Automatica')),
    rifornimento varchar(25) NOT NULL CHECK(rifornimento IN('Gasolio', 'Benzina'))
);

INSERT INTO Automobili VALUES (1,'EZ667SJ','VOLVO V40','grigia','7','Usata','Manuale','Gasolio'), (2,'FG709MR','FIAT 500L','rossa','6','Usata','Manuale','Gasolio'), (3,'FK770JC', 'CYTROEN C3 PICASSO','bianca','3','Usata','Manuale','Gasolio'), (4,'FA578GR', 'DOBLO', 'bianca', 'Magazzino','Usata','Manuale','Gasolio'), (5,'FB726BD', 'DOBLO','grigia','5','Usata','Manuale','Gasolio'); 
